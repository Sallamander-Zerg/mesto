...
import { initialCards, obj } from "../scripts/constData.js";
...
const formEdit = document.querySelector(".js-popup-for-edit");
const formCardAdd = document.querySelector(".js-popup-for-add");
const buttonAddProfile = document.querySelector(".profile__add-button");
const buttonEditProfile = document.querySelector(".profile__edit-button");
const buttonCloseAddProfile = document.querySelector(".js-close-butoon-add");
const buttonCloseEditProfile = document.querySelector(".js-close-button-edit");
